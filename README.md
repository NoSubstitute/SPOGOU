...
An easy to use addon to set passwords on many users (a class or an entire school year) provided only an address to a Google Workspace group or selection of a Classroom, and share the results back to the teacher who asked for it.
